...
export function ProjectsGrid({ initialProjects, title = "Open Source Projects" }: ProjectsGridProps) {
    const [activeFilter, setActiveFilter] = useState("all")

    const filteredProjects = activeFilter === "all" ? initialProjects : initialProjects.filter((p) => p.status === activeFilter)
